...
- **Cluster 1:** Low bonuses, short tenure, low income.
- **Cluster 2:** Moderate bonuses, medium tenure, moderate income.
- **Cluster 3:** High bonuses, long tenure, high income.

---

## Key Business Insights

- High agent bonuses are associated with long-tenured and older customers.
- Regions like Northern and Western India perform better than Eastern and Southern regions.
- Married or divorced customers purchase policies in higher volumes.
...
- **Data Preparation:** Address missing values, transform categorical variables, and scale data using Z-score.
- **EDA:** Understand data distribution, relationships, and insights.
- **Model Building:** Use linear regression for bonus prediction.
...
- Sales dominated by agents over third-party and online channels.
- Northern and Western regions outperform Eastern and Southern regions.
- Married and divorced customers are key buyers, with salaried and small-business owners as major segments.

### Significant Predictors for Bonuses
...
- **Linear Regression:** Base model for predicting bonuses.
- **Decision Tree Regressor:** Decision support tool for conditional predictions.
- **Random Forest Regressor:** Improved overfitting but computationally expensive.
- **Artificial Neural Network (ANN):** Captures complex non-linear relationships.
